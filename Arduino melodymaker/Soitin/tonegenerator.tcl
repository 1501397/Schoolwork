...
//  
//  Running on Linux arekhol@ODTUBU 4.13.0-37-generic #42~16.04.1-Ubuntu SMP Wed Mar 7 16:03:28 UTC 2018 x86_64
//  
...
solution file add ./melodymaker.cpp -type C++
...
go new
directive set -DESIGN_HIERARCHY melodymaker
go compile
solution library add mgc_Altera-Cyclone-IV-E-6_beh_aq -- -rtlsyntool Quartus -manufacturer Altera -family {Cyclone IV E} -speed 6 -part EP4CE22F17C6
go libraries
...
go assembly
directive set /melodymaker/core/main -PIPELINE_INIT_INTERVAL 1
go architect
go extract
